...
void AprsPlugin::aprsObjectUpdated( AprsObject *object )
{
    Q_UNUSED( object );
...
void AprsPlugin::restartGatherers()
{
    ...
    if ( m_useInternet ) {
        ...
        connect( m_tcpipGatherer, SIGNAL( objectUpdated( AprsObject* ) ),
                 this, SLOT( aprsObjectUpdated( AprsObject* ) ) );
    }
    ...
    if ( m_useTty ) {
        ...
        connect( m_ttyGatherer, SIGNAL( objectUpdated( AprsObject* ) ),
                 this, SLOT( aprsObjectUpdated( AprsObject* ) ) );
    }
#endif
    ...
    if ( m_useFile ) {
        ...
        connect( m_fileGatherer, SIGNAL( objectUpdated( AprsObject* ) ),
                 this, SLOT( aprsObjectUpdated( AprsObject* ) ) );
    }
}
